...
function Tasks(props) {
  ...
  const calculateTimeLeft = (limitTime) => {
    ...
    const year = diffOfSecond.years();
    const month = diffOfSecond.months() + 1; // month()は0から11で表されるため、1を加算して1から12に変換する
    const day = diffOfSecond.dates();
    const hour = diffOfSecond.hours();
    const minute = diffOfSecond.minutes();
    const second = diffOfSecond.seconds();
