...
function Tasks(props) {
  ...
  const calculateTimeLeft = (limitTime) => {
    ...
    const year = diffOfSecond.year();
    const month = diffOfSecond.month() + 1; // month()は0から11で表されるため、1を加算して1から12に変換する
    const day = diffOfSecond.date();
    const hour = diffOfSecond.hour();
    const minute = diffOfSecond.minute();
    const second = diffOfSecond.second();
