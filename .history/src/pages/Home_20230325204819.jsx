...
function Tasks(props) {
  ...
  const convertDateForDisplay = (dataStr) => {
    const originalDateString = "2018-03-30";
    const [year, month, date] = originalDateString.split("-");
        ...
        .map((task, key) => (
          <li key={key} className="task-item">
            ...
            >
              ...
              <br />
              <span>
                締め切り: {undefined ? "" : convertDateForDisplay(task.limit)}
              </span>
              <br />
              <span>残り: {calculateTimeLeft(task.limit)}</span>
            </Link>
          </li>
        ))}
    </ul>
